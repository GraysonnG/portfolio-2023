...
<svelte:head>
	...
	<MetaTags title="Grayson Gullion | Portfolio | Contact" description="Contact me!" />
</svelte:head>
...
<section class="container">
	...
	>
		...
		<div class="name">
			<input bind:value={name} oninput={onNameChange} name="name" type="text" placeholder="Name" />
			{#if errorName}
